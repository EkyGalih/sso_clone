                ...
                @else
                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-green-600 text-sm leading-5">
                        <div class="group relative w-max">
                            ...
                            <span
                                class="pointer-events-none bg-gray-500 text-white absolute -top-7 left-0 w-max opacity-0 transition-opacity group-hover:opacity-100"
                            >
      This is a button.
    </span>
                        </div>
            ...
            <x-input-error class="mt-2" :messages="$errors->get('email_recovery')" />
        </div>
